  ...
  return (
    <div className={`${Styles.normal_flex}`}>
            ...
            <div className="flex" >
                ...
                font-[500] px-6 cursor-pointer uppercase`}onClick={()=>setActiveHeading(1)}>
                home
                </Link>
                <Link to={'/shop'}
                className={`${ActiveHeading===2?"text-[#007bc4]":"text-[#212121]"} 
                font-[500] px-6 cursor-pointer uppercase`}onClick={()=>setActiveHeading(2)}>
                shop
                </Link>
                <Link to={'/about'}
                className={`${ActiveHeading===3?"text-[#007bc4]":"text-[#212121]"} 
                font-[500] px-6 cursor-pointer uppercase`}onClick={()=>setActiveHeading(3)}>
                about us
                </Link>
                <Link to={'/contact'}
                className={`${ActiveHeading===4?"text-[#007bc4]":"text-[#212121]"} 
                font-[500] px-6 cursor-pointer uppercase`}onClick={()=>setActiveHeading(4)}>
                contact us
                </Link>
            </div>
