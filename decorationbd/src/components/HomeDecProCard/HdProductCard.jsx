...
const HdProductCard = ({data,open,setOpen}) => {
  ...
  return (
    <div className='w-full 768px:h-[450px] h-[420px] bg-white rounded-md card-container2
    shadow-sm 768px:p-3 1024px:p-2 1280px:p-[2px] 1500px:p-3 p-[6px] relative cursor-pointer'>
      <div className="flex justify-end">
            ...
            mx-auto 768px:mt-[5px] 1024px:mt-[2px] 1500px:mt-[5px] mt-[2px] 768px:mb-[5px] 1024px:mb-[2px] 1500px:mb-[5px]
             mb-[2px] 768px:h-[210px] h-[210px] object-cover'/>
            </Link>
        ...
        <Link>
          <h5 className='text-black 768px:mt-[10px] mt-[5px] 768px:ml-[5px] ml-[2px] text-[11px]
          300px:text-[13px] 768px:text-[16px] 1024px:text-[14px]  1500px:text-[16px] 
          italic 768px:font-[400] font-[500]'>{data.shop.name}</h5>
        </Link>  
        <Link to={`/product/${product_name}`}>
          <h4 className='pb-2 font-[500] text-[#077bc4] pt-1 768px:ml-[5px] ml-[2px] 
           300px:text-[16px] 768px:text-[19px] 1024px:text-[17px] 1280px:text-[15px] 1500px:text-[17px] text-[14px]'>
        ...
        <div className="stock2 text-[gray] flex items-center
         justify-between gap-[1px] mb-[5px] 768px:mr-[15px] 300px:mr-0 mr-[10px]">
            ...
            1500px:text-[16px] 300px:text-[14px] text-[13px]'/>
            <span className='capitalize font-semibold 768px:text-[16px] 1024px:text-[15px]
            1280px:text-[14px] 1500px:text-[16px] 300px:text-[14px]
            text-[13px] italic 768px:not-italic'>{data.stock}</span>)
          </div>
          <div className="price2 text-black  mr-[2px]">
            <span className='768px:text-[16px] 1024px:text-[14px] 1280px:text-[12px] 1500px:text-[14px]
            300px:text-[13px] hidden 300px:inline font-semibold '>BDT.</span>
            <span className='text-[#007bc4] font-bold 768px:mr-[5px] mr-[3px] 
            768px:text-[17px] 1024px:text-[14px] 1280px:text-[12px] 1500px:text-[14px]
            300px:text-[13px] text-[12px]'>{data.discount_price.toFixed(2)}<strong 
            className='768px:text-[17px] 1024px:text-[14px] 1280px:text-[12px] 1500px:text-[14px]
            ...
            <strong className='768px:text-[17px] 1024px:text-[14px] 1280px:text-[12px] 1500px:text-[14px]
