...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center 1024px:justify-start py-12 sm:px-6 lg:px-8 1280px:py-10 1350px:py-6">
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md 1350px:w-[80%] 1350px:max-w-[400px]
          ...
          <form className="space-y-6 ">
            ...
            <div className={`${styles.normal_flex} justify-between`}>
                <div className={`${styles.normal_flex}`}>
                    ...
                    />
                    <label htmlFor="remember-me" className="ml-2 block text-gray-800 1350px:text-[13px]">
                        Remember me
                    </label>
                </div>
                <div className="text-sm 1350px:text-[13px]">
            ...
            <div className={`${styles.normal_flex} justify-between`}>
                <div className={`${styles.normal_flex}`}>
                     ...
                     py-2 1350px:py-[6px] 300px:px-4 px-2 border border-transparent text-sm 1350px:text-[13px]
                     font-medium rounded-md text-white
                     bg-red-600 hover:bg-red-700 ">Continue with <span className="absolute 
                     300px:right-3 right-1
                     300px:top-2 top-[10px] items-center"><FcGoogle className="300px:text-[18px] 1350px:text-[15px] text-[14px]"/></span></button>
                </div>
                <div>
                <button type="submit" className=" relative 768px:w-[180px] 1350px:w-[150px] 
                     w-[122px] 300px:w-[155px] h-[40px] 1350px:h-[35px] flex
                     py-2 1350px:py-[6px] 300px:px-4 px-2 border border-transparent text-sm font-medium rounded-md text-white 1350px:text-[13px]
                     bg-blue-600 hover:bg-blue-700 ">Continue with <span className="absolute 
                     300px:right-3 right-1
                     300px:top-2 top-[10px]  items-center "><FaFacebookSquare className="300px:text-[18px] text-[14px] 1350px:text-[14px]"/></span></button>
                </div>
            </div>
            <div>
                    <button type="submit" className="group relative w-full h-[40px] 1350px:h-[35px] flex justify-center 
                    py-2 1350px:py-[6px] px-4 border border-transparent text-md font-medium rounded-md text-white 1350px:text-[13px]
                    bg-blue-600 hover:bg-blue-700 " onClick={()=>navigate('/profile')}>Login</button>
                </div>
                <div className={`${styles.normal_flex} w-full`}>
                    <h4 className="1350px:text-[13px]">Not have any acccount?</h4>
                    <Link to="/signUp" className="text-blue-600 pl-2 1350px:text-[13px]">
                        Sign Up
                    </Link>
                </div>
          </form>
