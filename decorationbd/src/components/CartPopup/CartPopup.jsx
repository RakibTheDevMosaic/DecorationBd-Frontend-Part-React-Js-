       ...
       bg-white flex flex-col justify-between 1280px:w-[25%] 768px:w-[60%] 1024px:w-[45%] w-[80%]
        ...
        <div>
            <div className="flex w-full justify-end pt-5 pr-5">
                <RxCross1  className='cursor-pointer 1024px:text-[22px] 1350px:text-[18px] text-[30px] text-[#242424]'
            ...
            <div className="768px:p-4 1024px:p-[2px] 1280px:p-2  p-[5px] flex items-center justify-between">
             ...
             <IoBagHandleOutline size={20} className='text-[#242424]'/>
                <h5 className='pl-2 text-[14px] font-semibold text-[#242424] pt-[2px]'>3 items</h5>
             </div>
         ...
         <div className="px-5 mb-[10px] 1350px:mb-[5px]">
            <Link to='/cart' onClick={()=>setOpencart(false)}>
                ...
                w-full flex items-center justify-center bg-[#305723] rounded-[10px]`}>
                    ...
                    text-[16px] 1280px:text-[14px] font-semibold'>View Cart</h1>
                </div>
            </Link>
        </div>
        {/* checkout button */}
