...
const ShopPage = ({open,setOpen}) => {
  ...
  return (
    <div className='ShopSection 1300px:w-11/12 1280px:w-[95%] w-[99%] mx-auto'>
      <div className="StickCatAndOtherFilltering hidden 1280px:block">
          <div className="heading">Filter by categories</div>
          ...
          <div className="mt-[50px]  1300px:w-[340px] w-[280px] text-center rounded-sm shadow shadow-[#242424]">
            <h3 className='font-semibold 1300px:text-[25px] text-[24px] capitalize p-[10px] bg-[#eee] rounded-md shadow shadow-[#077bc4]'>stock status</h3>
            <div className="p-[5px] text-center">
              <div >
              <input type="checkbox" className='h-[15px] w-[15px] mr-[5px] mb-[10px] mt-[10px] cursor-pointer'
               onChange={handleChange2}  value='on sale' id='slae1' name='sale'/>
            ...
            <input type="checkbox" className='h-[15px] w-[15px] mr-[5px] mb-[10px] cursor-pointer'
                 onChange={handleChange2} value='in stock' id='slae2' name='sale'/>
         ...
         }
        {
          ...
          <nav aria-label="Page navigation example ">
            <ul class="inline-flex -space-x-px text-sm">
              <li>
                <a href="#" class="flex items-center font-[600] justify-center px-3 h-8 ms-0 leading-tight text-white bg-[#077bc4] border border-e-0 border-gray-300 rounded-s-lg hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white"
                onClick={prePage}>Previous</a>
              </li>
             {
              numbers && numbers.map((n,i)=>(
                <li key={i} className={`${currentPage===n?" scale-[1.1]":""}`}>
                <a href="#" class={`${currentPage===n?"text-[orangered]":""}
              ...
              <li>
                <a href="#" class="flex items-center font-[600] justify-center px-3 h-8 leading-tight text-white bg-[#077bc4] border border-gray-300 rounded-e-lg hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white"
